...
class _SearchvideoState extends State<Searchvideo> {
  ...
  var decodeDetails, token, decodeDetailsData, decodeDetailsnew,continuewatchlist;
                    ...
                    children: [
                      ...
                      Provider.of<SqliteLocalDatabase>(context, listen: true).wathedvideolist==null||  Provider.of<SqliteLocalDatabase>(context, listen: true).wathedvideolist.isEmpty?Text('no videos watched'):Container(
                        ...
                        child: ListView.builder(
                            ...
                            itemCount: Provider.of<SqliteLocalDatabase>(context, listen: true).wathedvideolist.length>5?5:Provider.of<SqliteLocalDatabase>(context, listen: true).wathedvideolist.length,
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  print(Provider.of<SqliteLocalDatabase>(context, listen: false).wathedvideolist[index].videoid);
                                  print('ggggggggrrrrrrrrrrrrrrrrrrrrrrrrrraaaaaaaaaaaaaaaaaaaaaa');
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => Playcontinue(
                                              videoid1: Provider.of<SqliteLocalDatabase>(context, listen: false).wathedvideolist[index].videoid,
                                              durationwatched: Provider.of<SqliteLocalDatabase>(context, listen: false).wathedvideolist[index].duration
                                          )));
                                },
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: Image.network('https://img.youtube.com/vi/${Provider.of<SqliteLocalDatabase>(context, listen: true).wathedvideolist[index].videoid}/0.jpg',fit:BoxFit.cover)
                                    ),
                                  ),
                                ),
                              );
